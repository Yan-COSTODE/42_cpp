...
ClapTrap::~ClapTrap()
{
	std::cout << "\x1b[1;31mClapTrap Destructor called" << std::endl;
}

ClapTrap::ClapTrap()
{
	std::cout << "\x1b[1;32mClapTrap Default constructor called" << std::endl;
	name = "ClapTrap";
	hitPoints = 10;
	energyPoints = 10;
	attackDamage = 0;
...
{
	std::cout << "\x1b[1;32mClapTrap String constructor called" << std::endl;
	name = _name;
	hitPoints = 10;
	energyPoints = 10;
	attackDamage = 0;
...
{
	std::cout << "\x1b[1;32mClapTrap Copy constructor called" << std::endl;
	name = _other.name;
...
{
	std::cout << "\x1b[1;32mClapTrap Copy assignment constructor called" << std::endl;
	name = _other.name;
	hitPoints = _other.hitPoints;
	energyPoints = _other.energyPoints;
	attackDamage = _other.attackDamage;
